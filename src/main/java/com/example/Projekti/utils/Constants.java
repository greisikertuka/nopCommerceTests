...
public class Constants {
    ...
    public final static String pageURL = "https://demo.nopcommerce.com/";
    public final static User user = new User("Adam", "Smith", Gender.MALE, "greisikertuka@gmail.com", "TestNopCommerce123", "Lufthansa Industry Solutions", "7", "June", "1996", 7, 6, 1999);
