...
public class Constants {
    ...
    public final static User user = new User("Adam", "Smith", Gender.MALE, "gfdfwqeqwe@gmail.com", "TestNopCommerce123", "Lufthansa Industry Solutions", "7", "June", "1996", 7, 6, 1999);
